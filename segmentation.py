...
from uvnet.models import Segmentation, SegmentationTIZ
...
parser.add_argument(
    "--dataset", choices=("mfcad", "fusiongallery", "mfcadp"), help="Segmentation dataset"
)
...
-----------------------------------------------------------------------------------
    ...
    val_data = Dataset(
        root_dir=args.dataset_path, split="val", random_rotate=args.random_rotate
    )
    ...
    model = SegmentationTIZ(
        Dataset.num_classes(), val_data, 
