...
class FusionGalleryDataset(BaseDataset):
    ...
    def __init__(
        ...
        if split in ("train", "val"):
            ...
            train_filesplit, val_filesplit = train_test_split(full_train_filelist, test_size=0.2, random_state=42)
            if split == "train":
    ...
    def load_one_graph(self, file_path):
        ...
        label = np.loadtxt(self.seg_path.joinpath(file_path.stem + ".seg"), dtype=np.int, ndmin=1)
